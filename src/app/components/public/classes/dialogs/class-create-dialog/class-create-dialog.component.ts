...
import {ClassroomDTO, ClassroomTeacherDTO,} from '../../../../../core/types/dto/classroom/ClassroomDTO';
...
export class ClassCreateDialogComponent implements OnInit {
  ...
  public async createClassroom(): Promise<void> {
    ...
    const classroom: ClassroomDTO = {
      ...
      teacher:
        (this.classFormGroup.get('teacher')?.value as ClassroomTeacherDTO) ??
        ({} as ClassroomTeacherDTO),
      gradeLevel:
        (this.classFormGroup.get('gradeLevel')?.value as GradeLevel) ?? {},
      students: [],
    };
