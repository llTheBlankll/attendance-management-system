    ...
    <p-dialog
      ...
      <div class="grid">
        ...
        <div class="col-12 md:col-8">
          ...
          <p><strong>Class:</strong> {{ student?.classroom?.classroomName }}</p>
          <!-- Add more student details as needed -->
        </div>
      </div>
      <ng-template pTemplate="footer">
        <p-button icon="pi pi-check" (click)="visibleChange.emit();" label="Close" styleClass="p-button-text"></p-button>
      </ng-template>
    </p-dialog>
  `,
  styles: []
